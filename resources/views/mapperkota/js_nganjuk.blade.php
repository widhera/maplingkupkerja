        ...
        var baseMaps = {};
        var legend_nganjuk = L.control.layers(baseMaps,{'<img src="{{ asset('MAPPERKOTA/legend/KecBagor_21.png') }}" /> Kec. Bagor': layer_KecBagor_21,'<img src="{{ asset('MAPPERKOTA/legend/KecBaron_20.png') }}" /> Kec. Baron': layer_KecBaron_20,'<img src="{{ asset('MAPPERKOTA/legend/KecBerbek_19.png') }}" /> Kec. Berbek': layer_KecBerbek_19,'<img src="{{ asset('MAPPERKOTA/legend/KecGondang_18.png') }}" /> Kec. Gondang': layer_KecGondang_18,'<img src="{{ asset('MAPPERKOTA/legend/KecJatikalen_17.png') }}" /> Kec. Jatikalen': layer_KecJatikalen_17,'<img src="{{ asset('MAPPERKOTA/legend/KecKertosono_16.png') }}" /> Kec. Kertosono': layer_KecKertosono_16,'<img src="{{ asset('MAPPERKOTA/legend/KecLengkong_15.png') }}" /> Kec. Lengkong': layer_KecLengkong_15,'<img src="{{ asset('MAPPERKOTA/legend/KecLoceret_14.png') }}" /> Kec. Loceret': layer_KecLoceret_14,'<img src="{{ asset('MAPPERKOTA/legend/KecNganjuk_13.png') }}" /> Kec. Nganjuk': layer_KecNganjuk_13,'<img src="{{ asset('MAPPERKOTA/legend/KecNgetos_12.png') }}" /> Kec. Ngetos': layer_KecNgetos_12,'<img src="{{ asset('MAPPERKOTA/legend/KecNgluyu_11.png') }}" /> Kec. Ngluyu': layer_KecNgluyu_11,'<img src="{{ asset('MAPPERKOTA/legend/KecNgronggot_10.png') }}" /> Kec. Ngronggot': layer_KecNgronggot_10,'<img src="{{ asset('MAPPERKOTA/legend/KecPace_9.png') }}" /> Kec. Pace': layer_KecPace_9,'<img src="{{ asset('MAPPERKOTA/legend/KecPatianrowo_8.png') }}" /> Kec. Patianrowo': layer_KecPatianrowo_8,'<img src="{{ asset('MAPPERKOTA/legend/KecPrambon_7.png') }}" /> Kec. Prambon': layer_KecPrambon_7,'<img src="{{ asset('MAPPERKOTA/legend/KecRejoso_6.png') }}" /> Kec. Rejoso': layer_KecRejoso_6,'<img src="{{ asset('MAPPERKOTA/legend/KecSawahan_5.png') }}" /> Kec. Sawahan': layer_KecSawahan_5,'<img src="{{ asset('MAPPERKOTA/legend/KecSukomoro_4.png') }}" /> Kec. Sukomoro': layer_KecSukomoro_4,'<img src="{{ asset('MAPPERKOTA/legend/KecTanjunganom_3.png') }}" /> Kec. Tanjunganom': layer_KecTanjunganom_3,'<img src="{{ asset('MAPPERKOTA/legend/KecWilangan_2.png') }}" /> Kec. Wilangan': layer_KecWilangan_2,'<img src="{{ asset('MAPPERKOTA/legend/LingkupKerja_1.png') }}" /> Lingkup Kerja': layer_LingkupKerja_1,'<img src="{{ asset('MAPPERKOTA/legend/LAINYA_0.png') }}" /> LAINYA': layer_LAINYA_0,});
