function pop_KabupatenNganjuk_2(feature, layer) {
        ...
        var baseMaps = {};
        var legend_perkota = L.control.layers(baseMaps,{'<img src="{{ asset('MAPPERKOTA/legend/PERKOTA/KotaKediri_5.png') }}" /> Kota Kediri': layer_KotaKediri_5,'<img src="{{ asset('MAPPERKOTA/legend/PERKOTA/KabupatenKediri_4.png') }}" /> Kabupaten Kediri': layer_KabupatenKediri_4,'<img src="{{ asset('MAPPERKOTA/legend/PERKOTA/KabupatenJombang_3.png') }}" /> Kabupaten Jombang': layer_KabupatenJombang_3,'<img src="{{ asset('MAPPERKOTA/legend/PERKOTA/KabupatenNganjuk_2.png') }}" /> Kabupaten Nganjuk': layer_KabupatenNganjuk_2,'<img src="{{ asset('MAPPERKOTA/legend/LingkupKerja_1.png') }}" /> Lingkup Kerja': layer_LingkupKerja_1,'<img src="{{ asset('MAPPERKOTA/legend/LAINYA_0.png') }}" /> LAINYA': layer_LAINYA_0,});
