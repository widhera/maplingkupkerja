 function pop_Pesantren_2(feature, layer) {
        ...
        var baseMaps = {};
        var legend_kotakediri = L.control.layers(baseMaps,{'<img src="{{ asset('MAPPERKOTA/legend/KotaKediri_4.png') }}" /> Kota Kediri': layer_KotaKediri_4,'<img src="{{ asset('MAPPERKOTA/legend/Mojoroto_3.png') }}" /> Mojoroto': layer_Mojoroto_3,'<img src="{{ asset('MAPPERKOTA/legend/Pesantren_2.png') }}" /> Pesantren': layer_Pesantren_2,'<img src="{{ asset('MAPPERKOTA/legend/LingkupKerja_1.png') }}" /> Lingkup Kerja': layer_LingkupKerja_1,'<img src="{{ asset('MAPPERKOTA/legend/LAINYA_0.png') }}" /> LAINYA': layer_LAINYA_0,});